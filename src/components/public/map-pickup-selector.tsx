...
import { MapPin, MapPinIcon, Search } from "lucide-react";
...
interface MapLocationSelectorProps {
  title: string;
  pickupCoordinate?: LatLngExpression;
  setPickupCoordinate?: (coord: LatLngExpression) => void;
}

export function MapPickupSelector({
  title,
  pickupCoordinate,
  setPickupCoordinate,
  ...
  return (
    <Card className="p-6">
      ...
      <Textarea placeholder="Masukkan alamat penjemputan" />
          ...
          <MapDrawControl
            onLayersChange={(layers) => {
              ...
              if (lastMarker) {
                ...
                setPickupCoordinate?.(latlng);
              }
            }}
          >
            {pickupCoordinate && <MapDrawMarker />}
          </MapDrawControl>
          <MapLocateControl />
